...
class BumperCliff {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.bool(obj.bumper, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BumperCliff(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [bumper]
    data.bumper = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new BumperCliff(null);
