...
"""autogenerated by genpy from rei_robot_cruise/NavGoal.msg. Do not edit."""
import codecs
import sys
...
class NavGoal(genpy.Message):
  _md5sum = "76079389e9944c93b7011c612b3a9d95"
  _type = "rei_robot_cruise/NavGoal"
...
float64 w
"""
  __slots__ = ['point_name','level','target_pose']
  _slot_types = ['string','int8','geometry_msgs/PoseStamped']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_b3I().pack(_x.level, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.level, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs,) = _get_struct_b3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
